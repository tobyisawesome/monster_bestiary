...
public class Modelmiia<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "miia"), "main");
	private final ModelPart Head;
	private final ModelPart Body;
	private final ModelPart RightArm;
	private final ModelPart LeftArm;
	private final ModelPart Tail;
	private final ModelPart Tail2ndpart;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = partdefinition.addOrReplaceChild("Head",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(54, 16)
		...
		PartDefinition Tail = partdefinition.addOrReplaceChild("Tail",
				CubeListBuilder.create().texOffs(66, 1)
						.addBox(-3.5F, -12.0F, -2.0F, 7.0F, 12.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(0, 85)
		...
		PartDefinition Tail2ndpart = partdefinition.addOrReplaceChild("Tail2ndpart", CubeListBuilder.create()
				.texOffs(86, 4).addBox(-3.5F, -2.0F, -1.0F, 7.0F, 3.0F, 9.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 23.0F, 3.0F));

		PartDefinition ChestArea = partdefinition.addOrReplaceChild("ChestArea",
				CubeListBuilder.create().texOffs(0, 73).addBox(-11.0F, 0.5F, -0.0675F, 8.0F, 4.0F, 4.0F,
