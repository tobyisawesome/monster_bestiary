...
public class Modelsuu<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("monsterbestiary", "modelsuu"), "main");
		...
		PartDefinition Head = partdefinition
				.addOrReplaceChild(
						"Head", CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F))
								.texOffs(55, 0).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 16.0F, 8.0F, new CubeDeformation(0.5F)),
						PartPose.offset(0.0F, 0.0F, 0.0F));
		PartDefinition antenna = Head.addOrReplaceChild("antenna",
				CubeListBuilder.create().texOffs(55, 33).addBox(-1.0F, -6.0F, -4.0F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(79, 41)
		...
		PartDefinition Body = partdefinition
				.addOrReplaceChild("Body",
						CubeListBuilder.create().texOffs(16, 16).addBox(-4.0F, 0.0F, -2.0F, 8.0F, 12.0F, 4.0F, new CubeDeformation(0.0F))
								.texOffs(87, 0).addBox(-4.0F, 0.0F, -2.0F, 8.0F, 14.0F, 4.0F, new CubeDeformation(0.25F)),
						PartPose.offset(0.0F, 0.0F, 0.0F));
